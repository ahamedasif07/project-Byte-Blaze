...
const BlogCard = ({blog}) => {
    ...
    return (
      ...
      <div className="hover:scale-105 transition border-2 border-gray-500 rounded-md hover:border-red-600">
        <Link className="group  focus:no-underline dark:bg-slate-400 border-2 hover:scale-110 " to={`/blog/${id}`} rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-gray-900 dark:bg-gray-50">
