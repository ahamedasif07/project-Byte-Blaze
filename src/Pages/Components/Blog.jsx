...
const Blog = () => {
    ...
    const {comments_count, reading_time_minutes,title,
		...
		const handleBookMark =(blogDetais)=>{
			saveBlog(blogDetais)
	...
	{/* bookMaarks buttons */}
	<div onClick={()=>handleBookMark(blogDetais)} className="text-3xl text-success hover:scale-110 hover:bg-gray-300 rounded-full p-2">
